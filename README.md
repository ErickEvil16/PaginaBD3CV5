...
• Desarrollar una base de datos robusta, normalizada y funcional que permita gestionar información agrícola, complementada con una aplicación web que realice operaciones 

CRUD sobre los datos almacenados.
